...
const diskRead = () => new Promise((resolve, reject) => setTimeout(reject, 200, new Error('disk read fail!')))
...
Promise.all(promises)
  ...
  .catch(err => console.error(`${err.message} ${(Date.now() - start).toFixed(0)} ms`))
