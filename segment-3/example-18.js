...
planetsVisited.add('176050fb-db1d-42f2-ab89-5043200c5de9')
planetsVisited.add('d3494def-1e2c-48db-8c24-1d6043a3a4da')
planetsVisited.add('d3494def-1e2c-48db-8c24-1d6043a3a4da')  // added twice!

console.log('\nPlanets visited:')
for(let id of planetsVisited) {
  const p = planetsById.get(id)
  console.log(`\t${p.name}`)
}
