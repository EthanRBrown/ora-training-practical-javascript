...
const planetsById_Map = new Map(planets.map(p => [p.id, p]))

const planetsById = {}
for(let [id, p] of planetsById_Map) {
  planetsById[id] = p
}

const id = 'e26165c8-ea15-490f-80e5-3699d518d50a'
console.log(`planet ${id}: ${planetsById[id].name}`)
